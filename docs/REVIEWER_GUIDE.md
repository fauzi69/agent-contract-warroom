# Reviewer Guide — Contract Warroom
...
## Product objective
Audit a Solidity vault and generate severity-ranked findings.
...
print(run_pipeline_sync("Contract Warroom", {"subject":"contract_audit reviewer smoke"}))
PY
```
