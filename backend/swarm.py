"""Smart Contract War Room multi-agent reasoning core.
...
PROJECT_NAME = 'Smart Contract War Room'
DOMAIN = 'incident response'
AUDIENCE = 'protocol security teams'
AGENT_ROLES = ['Exploit Triage Lead', 'Blast Radius Mapper', 'Patch Strategy Agent', 'Comms Liaison', 'Postmortem Analyst']
SIGNALS = ['at_risk_tvl', 'exploit_confidence', 'affected_functions', 'pause_window_minutes', 'patch_complexity']
SCENARIOS = ['reentrancy alert', 'oracle manipulation incident', 'privileged key compromise']
